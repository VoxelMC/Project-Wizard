...
//WEAPONS
item_init_weapon(6,"Ice Wand",s_IceWand,"A wand that shoots ice projectiles.",weptype.wand,5,1)
item_init_weapon(7,"Fire Wand",s_FireWand,"A wand that shoots fire projectiles.",weptype.wand,10,2)
