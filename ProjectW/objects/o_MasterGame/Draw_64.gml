...
draw_sprite(s_BarBackground,image_index,30,525)
draw_sprite_part(s_HealthBar, 0, 0, 0, hspriteWidth*hpPercent, hspriteHeight, 30, 525);
...
draw_sprite(s_BarBackground,image_index,732,525)
draw_sprite_part(s_ManaBar, 0, 0, 0, mspriteWidth*manaPercent, mspriteHeight, 732, 525);

//Health/Mana Text
draw_set_color(c_black)
draw_text_transformed(90,528,string(global.CurrentHP) + "/" + string(global.MaxHP),0.30,0.30,0);
draw_text_transformed(807,528,string(global.CurrentMana) + "/" + string(global.MaxMana),0.30,0.30,0);
draw_set_color(c_white)


//UI
draw_sprite(s_SpellSlot,image_index,290,545)
draw_sprite(s_SpellSlot,image_index,380,545)
draw_sprite(s_WeaponSlot,image_index,480,535)
draw_sprite(s_SpellSlot,image_index,580,545)
draw_sprite(s_SpellSlot,image_index,670,545)
